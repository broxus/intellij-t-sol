...
class SolKeywordCompletion : SolCompletionTestBase() {
  ...
  fun testThisKeywordNotInMemberAccess() = checkCompletion(
    hashSetOf("isNone", "makeAddrExtern", "isExternZero", "makeAddrStd", "wid", "transfer", "send", "balance", "isStdAddrWithoutAnyCast", "getType", "isStdZero", "unpack", "value", "currencies", "makeAddrNone"), """
        contract A {
            address a;

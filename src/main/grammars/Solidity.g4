 ...
 */
typeName: elementaryTypeName[true] | functionTypeName | mappingType | optionalType | identifierPath | typeName LBrack expression? RBrack;
...
optionalType: Optional LParen typeName RParen;

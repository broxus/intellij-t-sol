...
INTNUMTYPE=int([1-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-6])?
VARINTNUMTYPE=varInt(16|32)?
UINTNUMTYPE=uint([1-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-6])?
VARUINTNUMTYPE=varUint(16|32)?

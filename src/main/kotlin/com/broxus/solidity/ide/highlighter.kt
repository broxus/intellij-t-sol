...
object SolHighlighter : SyntaxHighlighterBase() {
  ...
  fun keywords() = setOf<IElementType>(
    ...
    PUBLIC, PRIVATE, INTERNAL, EXTERNAL, INLINE, INTERNALMSG, EXTERNALMSG, CONSTANT, PURE, VIEW, STATIC, ABSTRACT, FUNCTIONID, GETTER,
    IF, ELSE, FOR, WHILE, DO, REPEAT, BREAK, CONTINUE, THROW, USING, RETURN, RETURNS, RESPONSIBLE,
    MAPPING, EVENT, /*ERROR,*/ ANONYMOUS, MODIFIER, ASSEMBLY, OPTIONAL, VECTOR, STACK, EMPTYMAP, NULL, NAN,
    VAR, STORAGE, NOSTORAGE, MEMORY, WEI, ETHER, GWEI, SZABO, FINNEY, COINS,
  ...
  fun types() = setOf<IElementType>(
    BYTENUMTYPE, BYTESNUMTYPE, FIXEDNUMTYPE, INTNUMTYPE, VARINTNUMTYPE, UFIXEDNUMTYPE, UINTNUMTYPE, VARUINTNUMTYPE,
    STRING, BOOLTYPE, ADDRESS, ADDRESS_STD
  )
